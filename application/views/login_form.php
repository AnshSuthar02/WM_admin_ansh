   ...
   <div class="header-image">
      ...
      <div class="bs-example">
         ...
         <nav class="navbar navbar-expand-lg navbar-light bg-light mobile-display" style="color:white;">
            <a href="https://www.assignnmentinneed.com" class="navbar-brand">
               <img src="<?php echo base_url(); ?>assets/download3.png" class="mobile-image">
            </a>
         ...
         <nav class="navbar navbar-expand-sm notmobile" style="color:white;">
            ...
            <div class="row smallscreen">
               ...
               <div class="col-md-5" style="float: left;">
                  ...
                  <!-- <a href="https://www.assignnmentinneed.com" class="navbar-brand">
                     <img src="<?php echo base_url(); ?>assets/download3.png" style="width: 30%;margin:-22px 30px 0 20px;">
                  </a> -->
         ...
         <div class="row">
            ...
            <div class="col-md-2 mx-auto">
               ...
               <div style="margin-right: 10%;">
                  <p>Assignment In Need is an organization of over 200 people. We are based in UK and was established in 2014. Our team intends to write the assignment with proper quality as per the due date.</p>
               </div>
            ...
            <div class="col-md-2 mx-auto">
               ...
               <ul style="list-style-type: inherit;color: #fff;">
                  <li><a href="https://www.assignnmentinneed.com/contact-us/" style="color: #fff;">Call Back</a></li>
                  <li><a href="https://www.assignnmentinneed.com/prakash/order.php" style="color: #fff;">Order Now</a></li>
                  <li><a href="https://www.assignnmentinneed.com/contact-us/" style="color: #fff;">Connect With Us</a></li>
            ...
            <div class="col-md-2 mx-auto">
               ...
               <ul style=" list-style-type: inherit;color: #fff;">
                  <li><a href="https://www.assignnmentinneed.com/privacy-policy/" style="color: #fff;">Privacy Policy</a></li>
                  <li><a href="https://www.assignnmentinneed.com/guarantee-policy/" style="color: #fff;">Guarantee</a></li>
                  <li><a href="https://www.assignnmentinneed.com/refund-policy/" style="color: #fff;">Refund Policy</a></li>
                  <li><a href="https://www.assignnmentinneed.com/cancellation-policy/" style="color: #fff;">Cancellation Policy</a></li>
               </ul>
            ...
            <div class="col-md-2 mx-auto">
               ...
               <div class="textwidget">
                  <p><i class="icon-location"></i>International House, Constance Street, London E16</p>
