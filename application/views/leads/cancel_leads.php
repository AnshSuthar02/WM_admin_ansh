                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div style="margin-right: 2px;">
                                                            <button type="button" class="btn btn-xs btn-warning btn-sm m-1" data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $lead['id']; ?>" data-whatever="@getbootstrap">
                                                                Call
                                                            </button>
                                                        </div>
                                                         <?php if ($role_id == 1) { ?>
                                                                                    ...
                                                                                    ?>
                                                                                        <li class="msg-right">
                                                                                            <div class="msg-left-sub">
                                                                                                ...
                                                                                                <div class="msg-desc">
                                                                                                    <pre> <?php echo $call_list['description']; ?></pre>
                                                                                                </div>
